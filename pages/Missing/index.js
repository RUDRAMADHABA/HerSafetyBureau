              ...
              <form method="#" action="#" className="mt-10">
                ...
                <div className="flex">
                  ...
                  <label className="block font-medium text-sm text-gray-800 w-full">
                    If any of your closed ones or nearby women , girls is/are missing then you can file a complaint here.
                  </label>
                ...
                <div className="flex mt-7 justify-center w-full">
                  <Link href="/Missing/Complain">
                    <button className="mr-5 bg-pink-700 border-none px-4 py-2 rounded-xl cursor-pointer text-white shadow-xl hover:shadow-inner transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                      File a Complain
                    </button>
                  </Link>
                  <Link href="/Track">
